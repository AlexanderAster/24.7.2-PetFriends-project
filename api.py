...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        """Метод инициализирует авторизацию по указанным email и паролю.Вернёт статус-код и 
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод запроса списка питомцев по установленному фильтру. Вернёт статус-код и содержание. 
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет на сервер данные о добавляемом питомце, возвращает статус
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет на сервер запрос на удаление питомца по указанному ID, возвращает
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет запрос на сервер об обновлении фото питомца по указанному ID,
        возвращает статус запроса и result в формате JSON с обновлённыи данными питомца"""
        data = MultipartEncoder(
            fields={
                'pet_photo': (pet_photo, open(pet_photo, 'rb'), 'image/jpeg')
